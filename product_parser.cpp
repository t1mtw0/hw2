...
Product *ProductParser::parse(std::string category, std::istream &is,
                              bool &error, std::string &errorMsg, int &lineno) {
